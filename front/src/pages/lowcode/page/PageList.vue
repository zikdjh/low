      ...
      <div class="page-grid">
        ...
        >
          ...
          <div class="card-actions">
            ...
            <button class="action-btn edit" @click.stop="handleEdit(page)" title="编辑信息">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
              </svg>
            </button>
            <button class="action-btn download" @click.stop="handleDownload(page)" title="下载Vue文件">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <button class="action-btn delete" @click.stop="handleDelete(page)" title="删除页面">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M3 6h18" />
...
async function handleDownload(page: PageSchema) {
  try {
    await pageSchemaApi.downloadVueFile(page.id!, page.pageCode);
...
.action-btn.download:hover { background: #3b82f6; color: #fff; border-color: #3b82f6; }
